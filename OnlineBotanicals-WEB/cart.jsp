...
<link rel="stylesheet" href="/PlantsByWebSphere/PlantMaster.css" type="text/css"/>
...
<%@ page import="com.ibm.websphere.samples.plantsbywebsphereejb.ShoppingCartItem,java.util.*" session="true" isThreadSafe="true" isErrorPage="false" %>
...
<form onsubmit="return verifyForm();" target="_self" name="cartform" method="post" action="/PlantsByWebSphere/servlet/ShoppingServlet">
<table border="0" cellpadding="4" cellspacing="0" width="100%">
  <tr>
    <td class="trail"><p class="trail"><a class="trail" class="footer" href="/PlantsByWebSphere/promo.html" target="work">Home</a></p></td>
  </tr>
  <tr>
    <td width="100%">
            ...
            <tr>
              <td valign="top" colspan="6">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td nowrap>
                      <a href="/PlantsByWebSphere/servlet/ShoppingServlet?action=shopping" target="work">
                      <img src="/PlantsByWebSphere/images/button_continue_shopping.gif" alt="Continue Shopping" width="113" height="27" border="0"></a>
                    </td>
<%if (cartitems != null)
{
%>                    
                    <td>
                        <input type="image" name="Recalculate" value="updatequantity" alt="Recalculate" src="/PlantsByWebSphere/images/button_recalculate.gif">
                        <input type="hidden" name="action" value="updatequantity">
                    </td>
                    <td>
                      <a href="/PlantsByWebSphere/servlet/ShoppingServlet?action=initcheckout" target="work">
                      <img src="/PlantsByWebSphere/images/button_checkout_now.gif" alt="Checkout Now" width="95" height="27" border="0"></a>
                    </td>
<%
}
%>
