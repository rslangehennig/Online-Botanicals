...
%>
<form onsubmit="return verifyForm(this);" target="_self" name="reginfo" method="POST" action="/PlantsByWebSphere/servlet/AccountServlet?action=accountUpdate">
...
<tbody>  
  ...
  <tr>
    <td></td> 
    <td colspan="2"><input type="image" alt="Register" src="/PlantsByWebSphere/images/button_update.gif"><a href="javascript:verifyForm(this);"></a></td>
  </tr>
  </tbody>
