...
<%
  ...
  String updating = (String) request.getAttribute(com.ibm.websphere.samples.plantsbywebsphereejb.Util.ATTR_UPDATING);
...
<form onsubmit="return verifyFields(this);" target="_self" name="signinForm" method="post" action="/PlantsByWebSphere/servlet/AccountServlet?action=login&<%=servletParm%>">
<table border="0" cellpadding="0" cellspacing="5" width="100%">
  <tr>
    <td><p class="trail"><a class="trail" class="footer" href="/PlantsByWebSphere/promo.html" target="work">Home</a></p></td>
  </tr>
  <tr>
    <td width="100%">
            ...
            <table width="600" border="0" cellpadding="2" cellspacing="0">
              ...
              <tr>          
                <td colspan="2"> <font color="#ff0033">
                  <% String results;
                     results = (String) request.getAttribute(com.ibm.websphere.samples.plantsbywebsphereejb.Util.ATTR_RESULTS);
                     if ( results != null )
                        out.print(results);
                  %></font>
                </td>
              ...
              <tr>
                <td colspan="2">
                  <input type="image" name="action" VALUE="login" alt="Sign in" SRC="/PlantsByWebSphere/images/button_sign_in.gif"><a href="javascript:verifyFields(this);"></a>
                  <br><br></td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="2"><p>If you are a <i>New</i> customer you can
                  <a href="/PlantsByWebSphere/register.jsp" target="work">register for your own account here</a>.
                  </p><br>
                </td>
              </tr>
            </table>
