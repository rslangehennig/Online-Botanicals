...
%>
<form onsubmit="return verifyForm(this);" target="_self" name="reginfo" method="POST" action="/PlantsByWebSphere/servlet/AccountServlet?action=<%=formAction%>">
    ...
    <td width="100%">
      <table border="0" cellpadding="0" cellspacing="10" width="600">
        ...
        <tr>
          ...
          (<img border="0" src="/PlantsByWebSphere/images/required.gif" width="10" height="15" alt="Required
...
<tbody>
  ...
  <tr>
    <td></td> 
    <td colspan="2"><input type="image" alt="Register" src="/PlantsByWebSphere/images/button_register.gif"><a href="javascript:verifyForm(this);"></a></td>
  </tr>
