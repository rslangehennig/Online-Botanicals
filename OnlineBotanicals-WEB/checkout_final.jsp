...
<%@ page import="com.ibm.websphere.samples.plantsbywebsphereejb.ShoppingCartItem" session="true" isThreadSafe="true" isErrorPage="false" %>
<jsp:useBean id="cartitems" type="java.util.Collection" scope="request" />
<%
com.ibm.websphere.samples.plantsbywebsphereejb.OrderInfo orderInfo = 
      (com.ibm.websphere.samples.plantsbywebsphereejb.OrderInfo) 
      request.getAttribute(com.ibm.websphere.samples.plantsbywebsphereejb.Util.ATTR_ORDERINFO);
...
float shiptotal = com.ibm.websphere.samples.plantsbywebsphereejb.Util.getShippingMethodPrice(orderInfo.getShippingMethod());
float total = subtotal + shiptotal;
String shipMethod = com.ibm.websphere.samples.plantsbywebsphereejb.Util.getShippingMethod(orderInfo.getShippingMethod());
%>

<!--
<form method="post" action="/PlantsByWebSphere/servlet/ShoppingServlet">
-->
<table border="0" cellpadding="4" cellspacing="0" width="100%">
  <tr>
    <td><p class="trail"><a class="trail" class="footer" href="/PlantsByWebSphere/promo.html" target="work">Home</a> &gt; <a class="trail" class="footer" href="/PlantsByWebSphere/cart.jsp" target="work">Shopping Cart</a> &gt; <a class="footer" href="/PlantsByWebSphere/orderinfo.jsp" target="work">Checkout</a><br></td>
  </tr>
  <tr>
    <td width="100%">
...
<tbody>
  <tr>
    <td valign="top" width="32%" bgcolor="#ffffdd">
      ...
      <td bgcolor="#ffffff"><img src="/PlantsByWebSphere/images/1x1_trans.gif" width="4" height="4" border="0" alt=""></td>
    <td valign="top" width="34%" bgcolor="#ffffdd">
      ...
      <th class="item">SHIPPING ADDRESS</th>
        ...
        <!--
        <tr>
          <td width="100%"><img border="0" src="/PlantsByWebSphere/images/button_change.gif" width="58" height="27" alt="Change button"></td>
        </tr>
        -->
      </table>
...
&nbsp;
            ...
            <caption>Order Details</caption>
              <tr bgcolor="#eeeecc">
                <th><img src="/PlantsByWebSphere/images/1x1_trans.gif" width="4" height="4" align="left" border="0" alt=""></th>
...
%>                                           
              ...
              <tr bgcolor="#ffffdd">
    	       <td valign="top"><img src="/PlantsByWebSphere/images/1x1_trans.gif" width="2" height="22" align="left" border="0" alt=""></td>
              ...
              <td valign="top" colspan="8">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td nowrap>
                      <form method="post" action="/PlantsByWebSphere/servlet/ShoppingServlet">
                        <input type="image" name="Continue Shopping" value="shopping" alt="Continue Shopping" src="/PlantsByWebSphere/images/button_continue_shopping.gif">
                        <input type="hidden" name="action" value="shopping">
                      </form>
                    </td>
                    <td>
                      <form method="post" action="/PlantsByWebSphere/servlet/ShoppingServlet">
                        <input type="image" name="Checkout Now" value="completecheckout" alt="Checkout Now" src="/PlantsByWebSphere/images/button_submit_order.gif">
