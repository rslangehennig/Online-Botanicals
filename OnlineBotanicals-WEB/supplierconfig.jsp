...
<%@page import="com.ibm.websphere.samples.plantsbywebsphereejb.SupplierInfo,,com.ibm.websphere.samples.plantsbywebsphereejb.Util,java.util.*" session="true" isThreadSafe="true" isErrorPage="false"%>
<%
com.ibm.websphere.samples.plantsbywebsphereejb.SupplierInfo supplierInfo = 
      (com.ibm.websphere.samples.plantsbywebsphereejb.SupplierInfo) 
      session.getAttribute(com.ibm.websphere.samples.plantsbywebsphereejb.Util.ATTR_SUPPLIER);
String id = "";
String name = "";
String street = "";
String city = "";
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	<tbody>
		<tr>
			<td><img src="/PlantsByWebSphere/images/poweredby_WebSphere.gif"
			...
			Home</a>&nbsp;&nbsp;:&nbsp; <a class="footer"
				href="/PlantsByWebSphere/help.jsp" target="_blank">Help</a></p>
			</td>
		</tr>
	</tbody>
</table>
