...
<%
String checkedParm = " ";
if (com.ibm.websphere.samples.plantsbywebsphereejb.Util.debugOn())
{
   checkedParm = "checked";
}
%>
...
<a href="/PlantsByWebSphere/docs/en/techNotes.html" target="_blank">see the TechNotes</a>.
...
<tr>
   <td width="100%">
      <A href="/PlantsByWebSphere/servlet/AdminServlet?admintype=populate">(Re)Populate DataBase</A> - Populate the Plants By WebSphere Database.
   </td>
</tr>
<tr>
   <td></td>
...
<br>
<form onsubmit="return goodbye();" target="_self" method="post" action="/PlantsByWebSphere/servlet/AccountServlet?action=SetLogging">
